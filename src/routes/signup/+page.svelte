...
<div class="page">
  <header class="page-header">
    ...
    <h1 class="page-header__title">Create your Spencer's account</h1>
  </header>
  <section class="page-section">
    <form use:enhance method="POST">
      <TextField label="First name" type="text" id="first_name" name="first_name" required />
      <TextField label="Last name" type="text" id="last_name" name="last_name" required />
