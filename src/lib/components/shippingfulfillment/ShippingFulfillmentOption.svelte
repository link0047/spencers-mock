...
>
  ...
  <div class="option__desc" class:nosize-color-selected={noSizeSelected}>
...
<style>
  ...
  .fulfillment__option:active:not(:disabled):not(.loading):not(
  ...
  [data-state="selected"]:not(:disabled) .option__desc {
    color: #008300;
  }

  :global([data-state="selected"]:not(:disabled) .option__desc > span) {
    color: #c2452d;
  }

  :global([data-state="selected"]:not(:disabled) .option__desc > svg) {
    fill: #c2452d;
  }
